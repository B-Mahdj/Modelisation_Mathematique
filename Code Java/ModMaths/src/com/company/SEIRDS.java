...
public class SEIRDS {
    ...
    private double zeta;      //taux de perte d'immunité : 1/temps durant lequel on est immunisé (en 1 jour)

    /*---------------------------------------Declaration du constructeur---------------------------------------*/

    public SEIRDS (int P, double R0, double Temps_Infectieux, double natalite, double temps_incubation, double mortalite, double mortalite_virus, double temps_immunité) {
        this.population = P;
    ...
    private double Calculer_Sains () {  //calcule l'evolution de la population saine sur une journee
        return sains + ((-1*beta*sains*infectes)/population) + v*population - mu*sains + zeta*retires;
    }
    ...
    private double Calculer_Retires () {   //calcule l'evolution de la population retiree sur une journee
        return retires + (gamma*infectes) - mu*retires - zeta*retires;
    }
